...
const SET_LEFT_VISIBLE_DATE = 'SET_LEFT_VISIBLE_DATE';
const SET_RIGHT_VISIBLE_DATE = 'SET_RIGHT_VISIBLE_DATE';
...
export function setLeftVisibleDate(leftVisibleDate) {
    return {
        type: SET_LEFT_VISIBLE_DATE,
        payload: {
            leftVisibleDate
        }
    };
